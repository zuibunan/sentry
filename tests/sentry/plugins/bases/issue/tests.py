...
class IssuePlugin2GroupAction(PluginTestCase):
    plugin = TestIssuePlugin2

    def setUp(self):
        super(IssuePlugin2GroupAction, self).setUp()
        self.project = self.create_project()
        self.group = self.create_group(project=self.project)
        self.plugin_instance = plugins.get(slug=TestIssuePlugin2.slug)
...
class IssuePlugin2ProjectAction(PluginTestCase):
    plugin = TestIssuePlugin2
