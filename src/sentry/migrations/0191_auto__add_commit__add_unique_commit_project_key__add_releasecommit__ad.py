...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sentry_commit', (
            ...
            ('author', self.gf('sentry.db.models.fields.foreignkey.FlexibleForeignKey')(to=orm['sentry.CommitAuthor'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('sentry', ['Commit'])

        # Adding unique constraint on 'Commit', fields ['project', 'key']
        db.create_unique('sentry_commit', ['project_id', 'key'])
        ...
        # Adding unique constraint on 'CommitAuthor', fields ['project', 'email']
        db.create_unique('sentry_commitauthor', ['project_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'CommitAuthor', fields ['project', 'email']
        db.delete_unique('sentry_commitauthor', ['project_id', 'email'])
        ...
        # Removing unique constraint on 'Commit', fields ['project', 'key']
        db.delete_unique('sentry_commit', ['project_id', 'key'])
    ...
    models = {
        ...
        'sentry.commit': {
            'Meta': {'unique_together': "(('project', 'key'),)", 'object_name': 'Commit'},
            'author': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.CommitAuthor']"}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.commitauthor': {
            'Meta': {'unique_together': "(('project', 'email'),)", 'object_name': 'CommitAuthor'},
